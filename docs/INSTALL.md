...
curl -fsSL https://raw.githubusercontent.com/tzap-org/zmanager/main/install.sh \
  | ZMANAGER_VERSION=v1.0.8 ZMANAGER_INSTALL_DIR="$HOME/bin" sh
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/tzap-org/zmanager/main/install.sh \
  | sudo env ZMANAGER_VERSION=v1.0.8 ZMANAGER_INSTALL_DIR=/usr/local/bin sh
```
...
```sh
curl -LO https://github.com/tzap-org/zmanager/releases/download/v1.0.8/SHA256SUMS
curl -LO https://github.com/tzap-org/zmanager/releases/download/v1.0.8/zm-aarch64-apple-darwin.tar.gz
...
```sh
curl -LO https://github.com/tzap-org/zmanager/releases/download/v1.0.8/SHA256SUMS
curl -LO https://github.com/tzap-org/zmanager/releases/download/v1.0.8/zm-x86_64-unknown-linux-musl.tar.gz
sha256sum -c SHA256SUMS --ignore-missing
...
scripts/generate-package-metadata.sh \
  v1.0.8 \
  https://github.com/tzap-org/zmanager/releases/download/v1.0.8 \
  dist/SHA256SUMS \
