...
pub use x509::{
    ...
    inspect_tzap_x509_signer, test_tzap_with_optional_password_filter_and_x509_trust, test_tzap_with_password_filter,
    test_tzap_with_password_filter_and_x509_trust, test_tzap_with_recipient_key_filter_and_x509_trust, tzap_x509_signing_options_from_inventory,
